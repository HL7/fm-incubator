# FHIR Financial Management Incubator IG

This repository contains the HL7 Financial Management incubator Implementation Guide (IG) for resources being advanced toward future FHIR core inclusion.
